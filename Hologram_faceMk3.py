...
face_cascade = cv2.CascadeClassifier('C:\Users\Guining Pertin\Documents\opencv\sources\data\haarcascades\haarcascade_frontalface_default.xml')
...
def makeHologram(original,scale=1.5,scaleR=2.8,distance=0):
    '''
...
while(1):
    ...
    img_read = ImageGrab.grab(bbox=(0,70,700,600))
    ...
    rr = cv2.getTrackbarPos('R-high', 'RGB')
    gg = cv2.getTrackbarPos('G-high', 'RGB')
    bb = cv2.getTrackbarPos('B-high', 'RGB')
